...
[@cyberchain/smart-contract-wrapper](../README.md) / RPC\_WebSocket\_Provider

# Class: RPC\_WebSocket\_Provider

Defined in: src/rpc-provider-ws.ts:43
...
- [`I_RPC_WebSocket_Provider`](../interfaces/I_RPC_WebSocket_Provider.md)

## Constructors

### Constructor

> **new RPC\_WebSocket\_Provider**(`url`, `options?`): `RPC_WebSocket_Provider`

Defined in: src/rpc-provider-ws.ts:53
...
[`RPC_WS_Provider_Options`](../interfaces/RPC_WS_Provider_Options.md)
...
Defined in: src/rpc-provider-ws.ts:44
...
Defined in: src/rpc-provider-ws.ts:200
...
[`I_RPC_WebSocket_Provider`](../interfaces/I_RPC_WebSocket_Provider.md).[`on`](../interfaces/I_RPC_WebSocket_Provider.md#on)
...
Defined in: src/rpc-provider-ws.ts:145
