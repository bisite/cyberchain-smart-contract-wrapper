...
import { generateMixedWallet, parseAddress, parseQuantity, privateKeysToAddress, privateKeyToAddress, RPC_HTTP_Provider, RPC_WebSocket_Provider } from '../src';
...
const TEST_MIXED_WALLET = generateMixedWallet({
    mlDsaLevel: (parseInt(process.env.ML_DSA_LEVEL || "44") || 44) as any,
});
