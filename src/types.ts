...
/**
 * Key to sign a transaction with ECDSA
 */
export type SignKeyECDSA = {
    /**
     * Signature type
     */
    type: "ec-dsa";
...
/**
 * Key to sign a transaction with ML-DSA
 */
export type SignKeyMLDSA = {
    /**
     * Signature type
     */
    type: "ml-dsa";
 ...
 */
export type SignKey = SignKeyECDSA | SignKeyMLDSA;
...
export interface MethodTransactionOptions {
     ...
     */
    complementaryAddress: AddressLike;
